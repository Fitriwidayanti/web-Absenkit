    ...
    <div class="col-lg-7">
        ...
        <div class="table-respopnsive">
            <?php
                ...
                $hari=tanggal("D");
                $tanggal0=date('Y-m-d');
                $view1=mysqli_query($link,"SELECT 
                                        tb_pengguna.username, 
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <?php
                                $ada=mysqli_query($link,"SELECT id_jadwal, tanggal FROM tb_absensi WHERE tanggal='$tanggal0' AND id_jadwal='$row1[id_jadwal]'");
        ...
        <?php
    		...
    		echo "Tidak ada jadwal hari ini<br><br>Silahkan lihat <a href='http://localhost/guru/index.php?page=lihatjadwal'>jadwal</a>";
    	}
        ?>
    </div>
</div>
