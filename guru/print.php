<?php
    ...
    $tanggal2 = @$_GET['tgl2'];
    $kode = @$_GET['kelas'];
    $qry=mysqli_query($link,"SELECT nis, nama_siswa FROM tb_siswa WHERE id_kelas=$kode ORDER BY nis ASC");
    $no=1;
?>
<!DOCTYPE html>
<html lang="en">
...
<body onLoad="window.print()">
    <div class="container">
        <?php
            ...
            $qry1=mysqli_query($link,"SELECT kelas FROM tb_kelas WHERE id_kelas=$kode");
            $row1=mysqli_fetch_array($qry1);

            $qry2=mysqli_query($link,"SELECT mapel FROM tb_mapel WHERE kode_mapel=$mapel");
    				...
    				<table class="table table-bordered">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo mysqli_num_rows(mysqli_query($link,"SELECT 
