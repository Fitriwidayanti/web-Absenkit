...
<?php
    ...
    $view2=mysqli_query($link,"SELECT tb_jadwal.id_kelas, tb_kelas.kelas FROM tb_jadwal, tb_kelas 
    ...
    $view4=mysqli_query($link,"SELECT 
                            tb_absensih.tanggal, 
                            tb_absensih.nis,
                            tb_siswa.id_kelas
                        FROM 
    ...
    <div class="col-lg-8">
        ...
        <form method="post">
            <div class="table-responsive">
                <?php
                    $view3=mysqli_query($link,"SELECT * FROM tb_siswa WHERE id_kelas='$kelasid'");
                    $no=0;
                ?>
    ...
    <?php
        if (@$_POST['input']){
            ...
            for($i=0;$i<$no;$i++){
                ...
                $query=mysqli_query($link,"INSERT INTO tb_absensi(id_jadwal, tanggal, nis, ket) VALUES('$id_jadwal','$tanggal','$nis','$ket')");
            ...
            if($cek==0){
                for($a=0;$a<$no;$a++){
                    ...
                    $query1=mysqli_query($link,"INSERT INTO tb_absensih(tanggal, nis, ket) VALUES('$tanggal','$nis','$ket')");
                }
            }
