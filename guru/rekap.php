	...
	<div class="row" style="margin-top:30px;">
	    ...
	    <div class="col-lg-8" style="border-left: 1px solid #ccc;">
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<?php
		            $view5=mysqli_query($link,"SELECT 
		            						tb_pengguna.username, 
		            						tb_mengajar.id_mengajar, 
		            						tb_mengajar.kode_mapel, 
		            						tb_guru.kode_guru
				    ...
				    <div id="<?php echo $row5['kode_mapel'] ?>" class="panel-collapse collapse" role="tabpanel">
				    	<div class="panel-body">
				        	<div class="row">
						        <div class="col-lg-12">
						            <?php
						            $view2 = mysqli_query($link,"SELECT * FROM tb_kelas");
						            ?>
						    ...
						    <div class="row">
						        <div class="col-lg-12">
						            ...
						            <?php
						                $view3 = mysqli_query($link,"SELECT * FROM tb_kelas");
						                $nomor3=0;
							                ...
							                <div class="row">
							                    ...
							                    <div class="col-lg-12" style="padding-right:20px; border-right: 1px solid #ccc;">
							                        ...
							                        <table class="table table-hover table-bordered table-striped">
							                            ...
							                            <tbody>
							                                <?php
							                                    $view4=mysqli_query($link,"SELECT nis, nama_siswa
							                                                        FROM tb_siswa
							                                ...
							                                <tr>
							                                    ...
							                                    <td><?php echo mysqli_num_rows(mysqli_query($link,"SELECT 
							                                    		tb_pengguna.username, 
																		tb_mengajar.id_mengajar, 
																		tb_mengajar.kode_mapel, 
																		tb_guru.kode_guru,
