...
<div class="row" style="margin-top:30px;">
    <div class="col-lg-5">
        ...
        <?php
            $viow=mysqli_query($link,"SELECT tb_pengguna.username, tb_guru.nama_guru
        ...
        <?php
            $view=mysqli_query($link,"SELECT tb_pengguna.username, tb_mengajar.id_mengajar, tb_mengajar.kode_mapel, tb_guru.kode_guru, tb_mapel.mapel
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <table class="table table-hover table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                $view1=mysqli_query($link,"SELECT tb_pengguna.username, tb_mengajar.id_mengajar, tb_guru.kode_guru, 
                ...
                <div class="col-lg-6">
                    ...
                    <table class="table table-hover table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                $view2=mysqli_query($link,"SELECT tb_pengguna.username, tb_mengajar.id_mengajar, tb_guru.kode_guru, 
                                                    tb_jadwal.id_mengajar, tb_jadwal.hari, tb_jadwal.jam_mulai, tb_jadwal.jam_berakhir, tb_jadwal.id_kelas, 
                                                    tb_mengajar.kode_mapel, tb_kelas.kelas
                                                    FROM tb_pengguna, tb_mengajar, tb_guru, tb_jadwal, tb_kelas
                                                    WHERE tb_pengguna.id_pengguna='$id_login' AND tb_pengguna.username=tb_guru.nip AND tb_guru.kode_guru=tb_mengajar.kode_guru 
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <table class="table table-hover table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                $view3=mysqli_query($link,"SELECT tb_pengguna.username, tb_mengajar.id_mengajar, tb_guru.kode_guru, 
                                                    tb_jadwal.id_mengajar, tb_jadwal.hari, tb_jadwal.jam_mulai, tb_jadwal.jam_berakhir, tb_jadwal.id_kelas, 
                                                    tb_mengajar.kode_mapel, tb_kelas.kelas
                                                    FROM tb_pengguna, tb_mengajar, tb_guru, tb_jadwal, tb_kelas
                                                    WHERE tb_pengguna.id_pengguna='$id_login' AND tb_pengguna.username=tb_guru.nip AND tb_guru.kode_guru=tb_mengajar.kode_guru 
                ...
                <div class="col-lg-6">
                    ...
                    <table class="table table-hover table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                $view4=mysqli_query($link,"SELECT tb_pengguna.username, tb_mengajar.id_mengajar, tb_guru.kode_guru, 
                                                    tb_jadwal.id_mengajar, tb_jadwal.hari, tb_jadwal.jam_mulai, tb_jadwal.jam_berakhir, tb_jadwal.id_kelas, 
                                                    tb_mengajar.kode_mapel, tb_kelas.kelas
                                                    FROM tb_pengguna, tb_mengajar, tb_guru, tb_jadwal, tb_kelas
                                                    WHERE tb_pengguna.id_pengguna='$id_login' AND tb_pengguna.username=tb_guru.nip AND tb_guru.kode_guru=tb_mengajar.kode_guru 
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <table class="table table-hover table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                $view5=mysqli_query($link,"SELECT tb_pengguna.username, tb_mengajar.id_mengajar, tb_guru.kode_guru, 
                                                    tb_jadwal.id_mengajar, tb_jadwal.hari, tb_jadwal.jam_mulai, tb_jadwal.jam_berakhir, tb_jadwal.id_kelas, 
                                                    tb_mengajar.kode_mapel, tb_kelas.kelas
                                                    FROM tb_pengguna, tb_mengajar, tb_guru, tb_jadwal, tb_kelas
                                                    WHERE tb_pengguna.id_pengguna='$id_login' AND tb_pengguna.username=tb_guru.nip AND tb_guru.kode_guru=tb_mengajar.kode_guru 
                ...
                <div class="col-lg-6">
                    ...
                    <table class="table table-hover table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                $view6=mysqli_query($link,"SELECT tb_pengguna.username, tb_mengajar.id_mengajar, tb_guru.kode_guru, 
                                                    tb_jadwal.id_mengajar, tb_jadwal.hari, tb_jadwal.jam_mulai, tb_jadwal.jam_berakhir, tb_jadwal.id_kelas, 
                                                    tb_mengajar.kode_mapel, tb_kelas.kelas
                                                    FROM tb_pengguna, tb_mengajar, tb_guru, tb_jadwal, tb_kelas
                                                    WHERE tb_pengguna.id_pengguna='$id_login' AND tb_pengguna.username=tb_guru.nip AND tb_guru.kode_guru=tb_mengajar.kode_guru 
