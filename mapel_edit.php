...
<div class="row">
    <div class="col-lg-5">
        ...
        <?php
            $kode = @$_GET['id'];
            $qrykoreksi=mysqli_query($link,"SELECT * FROM tb_mapel WHERE id_mapel='$kode'");
        ...
        <?php
            if(@$_POST['edit']){
                ...
                $query=mysqli_query($link,"UPDATE tb_mapel SET kode_mapel='$kode_mapel', mapel='$mapel' WHERE id_mapel='$kode'");
