...
<div class="row">
    <div class="col-lg-5">
        ...
        if(@$_POST['input']){
            ...
            $query=mysqli_query($link,"INSERT INTO tb_mapel(kode_mapel, mapel) VALUES('$kode_mapel', '$mapel')");
    ...
    <div class="col-lg-7">
        ...
        <div class="table-responsive">
            <?php
                $view=mysqli_query($link,"SELECT * FROM tb_mapel ORDER BY kode_mapel ASC");
                $no=0;
