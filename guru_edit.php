...
<div class="row">
    ...
    <?php
        $id = @$_GET['id'];
        $qrykoreksi=mysqli_query($link,"SELECT * FROM tb_guru WHERE id_guru='$id'");
    ...
    <form method="post">
        <div class="col-lg-6">
            ...
            <?php
               $a=mysqli_query($link,"SELECT * FROM tb_pengguna WHERE username='$data->nip'"); 
...
<div class="row">
    ...
    if(@$_POST['edit']){
        ...
        $query=mysqli_query($link,"UPDATE tb_guru SET nip='$nip', nama_guru='$nama_guru', kode_guru='$kode_guru', jenis_kelamin='$jenis_kelamin', tempat_lahir='$tempat_lahir',
                            tanggal_lahir='$tanggal_lahir', alamat='$alamat', agama='$agama' WHERE id_guru='$id'");
        $query1=mysqli_query($link,"UPDATE tb_pengguna SET username='$nip' WHERE id_pengguna='$b->id_pengguna'");
        if($query){
        ?>
