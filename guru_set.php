...
<div class="row">
    <div class="col-lg-5">
        ...
        <form method="post">
            <div class="form-group">
                ...
                <select name="kode_guru" class="form-control" required>
                    ...
                    <?php 
                        $query=mysqli_query($link,"SELECT * FROM tb_guru ORDER BY nip ASC");
            ...
            <div class="form-group">
                ...
                <select name="kode_mapel" class="form-control" required>
                    ...
                    <?php 
                        $query=mysqli_query($link,"SELECT * FROM tb_mapel ORDER BY kode_mapel ASC");
                        while($row=mysqli_fetch_array($query))
                        {
                    ?>
        ...
        if(@$_POST['input']){
            ...
            $query=mysqli_query($link,"INSERT INTO tb_mengajar(kode_guru, kode_mapel) VALUES('$kode_guru','$kode_mapel')");
    ...
    <div class="col-lg-7">
        ...
        <div class="table-responsive">
            <?php
                $view=mysqli_query($link,"SELECT tb_guru.nama_guru, tb_mengajar.id_mengajar, tb_mapel.mapel FROM tb_guru, tb_mengajar, tb_mapel 
