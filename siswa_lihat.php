...
<div class="row">
    <div class="col-lg-12">
       <?php
        $kelas1 = mysqli_query($link,"SELECT * FROM tb_kelas");
        ?>
...
<div class="row">
    <div class="col-lg-12">
        <div class="tab-content responsive">
            <?php
                $kelas2 = mysqli_query($link,"SELECT * FROM tb_kelas");
                while($row2=mysqli_fetch_array($kelas2)){
                    $kelasid=$row2['id_kelas'];

                    $siswa=mysqli_query($link,"SELECT * FROM tb_siswa WHERE id_kelas='$kelasid'");
