...
<div class="row">
    <div class="col-lg-5">
        ...
        <?php
            $id = @$_GET['id'];
            $qrykoreksi=mysqli_query($link,"SELECT * FROM tb_pengguna WHERE id_pengguna='$id'");
        ...
        if(@$_POST['edit']){
            ...
            $query=mysqli_query($link,"UPDATE tb_pengguna SET username='$username', pass='$pass'  WHERE id_pengguna='$id'");
