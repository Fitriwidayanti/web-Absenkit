...
<div class="row">
    ...
    <?php
        $id = $_GET['id'];
        $qrykoreksi=mysqli_query($link,"SELECT * FROM tb_siswa WHERE id_siswa='$id'");
...
<div class="row">
    ...
    if(@$_POST['edit']){
        ...
        $query=mysqli_query($link,"UPDATE tb_siswa SET nis='$nis', nama_siswa='$nama_siswa', jenis_kelamin='$jenis_kelamin',
