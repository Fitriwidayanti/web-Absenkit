...
<div class="row">
    <div class="col-lg-5">
        ...
        <form method="post">
            <div class="form-group">
                ...
                <select name="status" class="form-control" required>
                    ...
                    <option value="tatausaha">GURU </option>
                </select>
            </div>
            <div class="form-group">
        ...
        if(@$_POST['input']){
            ...
            $query=mysqli_query($link,"INSERT INTO tb_pengguna(username, pass, status) VALUES('$username','$pass','$status')");
    ...
    <div class="col-lg-7">
        ...
        <div class="table-responsive">
            <?php
                $view=mysqli_query($link,"SELECT * FROM tb_pengguna ORDER BY username DESC");
                $no=0;
            ?>
