        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <select name="kelas" class="form-control" required>
                    ...
                    <?php 
                        $query=mysqli_query($link,"SELECT * FROM tb_kelas ORDER BY kelas ASC");
...
<div class="row">
    ...
    if(@$_POST['input']){
        ...
        $query=mysqli_query($link,"INSERT INTO tb_siswa(nis, nama_siswa, jenis_kelamin, tempat_lahir, tanggal_lahir, alamat, agama, nama_ortu, no_ortu, id_kelas) VALUES('$nis','$nama_siswa', '$jenis_kelamin',  '$tempat_lahir', '$tanggal_lahir', '$alamat', '$agama', '$nama_ortu', '$no_ortu', '$kelas')");
