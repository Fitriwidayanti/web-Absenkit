...
<form method="post">
    ...
    if(@$_POST['input']){
        ...
        $query1=mysqli_query($link,"INSERT INTO tb_pengguna(username, pass, status) VALUES('$username','$pass', '$status')");

        $query=mysqli_query($link,"INSERT INTO tb_guru(nip, nama_guru, kode_guru, jenis_kelamin, tempat_lahir, tanggal_lahir, alamat, agama) 
